...
Looking to ask a non-programming question? See the topics here to find a relevant site.</p> -->
				<footer class="blockquote-footer">
					<cite title="Source Title">Summarize your problem in a
						one-line title.</cite>
				</footer>
				<footer class="blockquote-footer">
					<cite title="Source Title">Describe your problem in more
						detail.</cite>
				</footer>
				<footer class="blockquote-footer">
					<cite title="Source Title">Describe what you tried and what
						you expected to happen.</cite>
				</footer>
				<footer class="blockquote-footer">
					<cite title="Source Title">add tags which help surface your
						question to members of the community.</cite>
				</footer>
			</blockquote>
		...
		<a href="All-posted-doubts" class="btn btn-primary">View All
			Posted Doubts</a>
	</div>
	...
	<div class="form-container">
		<form action="submitdoubts" method="POST">
			<label>Title:</label><br> <input type="text" name="title"
				required="required"><br> <label>What are the
				details of your problem?</label><br>
			<textarea name="details" required="required"></textarea>
			<br> <label>What did you try and what were you
				expecting?</label><br>
			<textarea name="expectation" required="required"></textarea>
			<br> <label>Tags</label><br> <input type="text" name="tags"
