...
<body>
	<div class="container">
		<div class="dashboard">
			<div class="profile">
				<img
					src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhmsLNKvHCGfEIVp_EHilrMquqemRKtV7m5CT4CqXPxg&s"
					alt="Profile Picture">
				<div class="profile-info">
					<h2>
						...
						<%=data.getId()%></h2>
					<h2>
						Full Name:<%=data.getFname() + " " + data.getLname()%>
					</h2>
					<p>
						Email:
						<%=data.getEmail()%></p>
					<p>
						Number:
						<%= Long.toString(data.getMob()) %>
					<p>
						Register date:<%=data.getCreatedAt()%>
				</div>
			</div>
